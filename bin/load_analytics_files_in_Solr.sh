...
do
  INPUT_JSONL=${FILE}.jsonl SOLR_COLLECTION=gxa-analytics  SCHEMA_VERSION=1 SOLR_PROCESSORS=dedupe solr-jsonl-chunk-loader.sh #SOLR_COLLECTION=bulk-analytics
  if [ $? -ne 0 ]; then
